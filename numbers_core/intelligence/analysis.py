...
def analyze_profile(profile: Dict[str, Any], lang: str = "ru", client: Any | None = None, model: str = "openai/gpt-5-chat") -> str:
    ...
    try:
        if hasattr(client, "chat"):
            ...
            raise TypeError("client must have .chat(system,user) or .analyze_profile(profile) or .generate(prompt)")
