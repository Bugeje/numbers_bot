from numerology import name_to_numbers
from numerology import reduce_number, extract_base
from numerology import calculate_expression_number, calculate_life_path_number
